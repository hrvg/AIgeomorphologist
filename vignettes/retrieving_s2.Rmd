...
```
which is appropriate as the cloud percentage remains low, at least `r sensing_limit` tiles are sensed for any tile, and less than 3 TB of SAFE data have to be downloaded.
